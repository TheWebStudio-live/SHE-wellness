      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative min-h-20 sm:min-h-20 md:h-20 lg:h-24 flex items-center justify-center w-full overflow-hidden">
          ...
          <div className="flex items-center justify-center w-full max-w-full px-2">
            <div 
              className={`flex items-center justify-center flex-wrap lg:flex-nowrap space-x-1.5 sm:space-x-2 md:space-x-4 lg:space-x-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-light text-primary/80 transition-all duration-300 transform ${
