  ...
  return (
    <>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="bg-card rounded-2xl p-8 md:p-12 max-w-4xl mx-auto border">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-4" data-testid="text-mission-title">
                Our Mission
              </h2>
