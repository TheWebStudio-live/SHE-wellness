      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-6" data-testid="text-about-title">
              About Your Coach
            </h2>
            <h3 className="text-xl text-primary font-semibold mb-4" data-testid="text-coach-name">
              Meet Peta Williams: Your Transformation Coach
            </h3>
            <div className="prose prose-lg max-w-none">
              <p className="text-muted-foreground leading-relaxed mb-4" data-testid="text-coach-bio-1">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4" data-testid="text-coach-bio-2">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6" data-testid="text-coach-bio-3">
