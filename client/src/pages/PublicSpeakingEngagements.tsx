      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground/80 max-w-3xl mx-auto mb-8 italic font-normal text-[13px]" data-testid="text-credentials">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="hover-elevate" data-testid="card-topic-women-heal-rise">
              <CardHeader>
                ...
                <CardTitle className="text-lg font-serif whitespace-nowrap overflow-hidden text-ellipsis">Empowering Women to Heal & Rise</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="mb-4">
            ...
            <Card className="hover-elevate" data-testid="card-topic-next-generation-leaders">
              <CardHeader>
                ...
                <CardTitle className="text-lg font-serif whitespace-nowrap overflow-hidden text-ellipsis">Inspiring the Next Gen of Leaders</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="mb-4">
                  <p className="text-sm text-muted-foreground mb-2">
            ...
            <Card className="hover-elevate" data-testid="card-topic-resilience-wellbeing">
              <CardHeader>
                ...
                <CardTitle className="text-lg font-serif whitespace-nowrap overflow-hidden text-ellipsis">Resilience for Professionals</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="mb-4">
                  <p className="text-sm text-muted-foreground mb-2">
