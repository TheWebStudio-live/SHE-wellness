...
export default function SHECollection() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative py-12 min-h-[50vh] flex items-center bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-green-950/20 dark:via-emerald-950/20 dark:to-teal-950/20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-transparent to-accent/10"></div>
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 20% 30%, rgba(115, 160, 132, 0.08) 0%, transparent 50%),
                           radial-gradient(circle at 80% 40%, rgba(76, 140, 102, 0.06) 0%, transparent 50%),
                           radial-gradient(circle at 40% 70%, rgba(134, 167, 132, 0.04) 0%, transparent 50%)`
        }}></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center">
            <Button size="lg" className="bg-green-700 hover:bg-green-800 text-white border-green-700" data-testid="button-shop-now">
              Shop Now
            </Button>
          </div>
