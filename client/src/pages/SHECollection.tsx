...
export default function SHECollection() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative py-1 min-h-[60vh] flex items-center bg-gradient-to-br from-stone-50 via-stone-100 to-amber-50 dark:from-stone-950/30 dark:via-stone-900/30 dark:to-amber-950/20 overflow-hidden">
